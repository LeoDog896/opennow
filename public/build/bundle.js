...
var app = (function () {
    ...
    /* src/Tailwindcss.svelte generated by Svelte v3.44.2 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "placeholder", "Type in a URL");
    			add_location(input, file, 5, 0, 102);
    			add_location(button, file, 6, 0, 155);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => location.href = url;
    	$$self.$capture_state = () => ({ Tailwindcss, url });
    	...
    	return [url, input_input_handler, click_handler];
    }
